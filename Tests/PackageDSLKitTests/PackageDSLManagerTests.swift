...
struct PackageDSLManagerTests {
    ...
    func generatePackageSwiftCreatesFiles() async throws {
        ...
        let packageManager = await PackageDSLManager(packageURL: tempDirectory, packageName: "TestPackage")
    ...
    func generateAndValidateComplexPackage() async throws {
        ...
        let packageManager = await PackageDSLManager(packageURL: tempDirectory, packageName: "ComplexTestPackage")
        ...
        try await packageManager
            ...
            .addTarget(name: "NetworkingCoreTests", type: .test, dependencies: [DependencyRef(name: "NetworkingCore")])
            .addTarget(name: "CLI", type: .executable, dependencies: [DependencyRef(name: "NetworkingCore")])
            ...
            .addDependency(url: "https://github.com/apple/swift-argument-parser.git", requirement: .upToNextMajor(from: "1.3.0"))
    ...
    func validateGeneratedPackageWithSPMCommands() async throws {
        ...
        let packageManager = await PackageDSLManager(packageURL: tempDirectory, packageName: "SPMValidationTest")
